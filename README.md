...
- Create two virtual machines
  - If you need help creating your virtual machines, please see my tutorial [here](https://github.com/carellanonicolas/vm-azure).
...
Lets log into Client-1 with one of the users that were created (in our instance "base.miku", password will be Password1)
